...
describe('Create cell references for related rows, columns, boxes', function () {
  ...
  describe('Convert sudokuGrid from string to array and back', function () {
    it('convert to array', function () {
      ...
      assert.sameOrderedMembers(gridArray[2] as number[], [])
      assert.sameDeepOrderedMembers(gridArray.slice(9, 18), [
        6,
        [],
        [],
        1,
  ...
  describe('Format sudokuGrid to list possible answers for unanswered cells', function () {
    it('populate possible answers as subarray for cells marked 0', function () {
      ...
      assert.sameOrderedMembers(fmtGrid[2] as number[], [1, 2, 4])
      assert.equal(fmtGrid[39], 8)
      assert.sameOrderedMembers(fmtGrid[40] as number[], [5])
      assert.equal(fmtGrid[80], 9)
      assert.sameOrderedMembers(fmtGrid[78] as number[], [1, 3, 4, 6])
    })
  })
  describe('Filter sudokuGrid to return open, solved, and cell answers', function () {
    ...
    it('valid return of open cells', function () {
      ...
      assert.sameOrderedMembers(getOpen(row2, sudokuGrid), [
        72,
        73,
        74,
        75,
      ...
      assert.sameOrderedMembers(getOpen(box1, sudokuGrid), [
        28,
        29,
        37,
        38,
      ...
      assert.sameOrderedMembers(getOpen(box2, sudokuGrid), [
        33,
        34,
        42,
        43,
    ...
    it('valid return of solved cells', function () {
      ...
      assert.sameOrderedMembers(getSolved(column1, sudokuGrid), [
        0,
        9,
        27,
        36,
      ...
      assert.sameOrderedMembers(getSolved(column2, sudokuGrid), [
        4,
        13,
        31,
        49,
    ...
    it('valid return of answer sets(solved or possible answer arrays)', function () {
      ...
      assert.sameOrderedMembers(
        getOpenValues(row1, sudokuGrid)[0] as number[],
        [1, 2, 4]
      )
      assert.sameOrderedMembers(
        getOpenValues(row1, sudokuGrid)[5] as number[],
        [2, 4, 8]
      )
      assert.sameOrderedMembers(
        getOpenValues(row2, sudokuGrid)[0] as number[],
        [1, 2, 3]
      )
      assert.sameOrderedMembers(
        getOpenValues(row2, sudokuGrid)[5] as number[],
        [1, 3, 4, 6]
      )
      ...
      assert.sameOrderedMembers(
        getOpenValues(column1, sudokuGrid)[0] as number[],
        [1, 2]
      )
      assert.sameOrderedMembers(
        getOpenValues(column1, sudokuGrid)[3] as number[],
        [1, 2, 3]
      )
      assert.sameOrderedMembers(
        getOpenValues(column2, sudokuGrid)[0] as number[],
        [3, 4]
      )
      assert.sameOrderedMembers(
        getOpenValues(column2, sudokuGrid)[2] as number[],
        [3, 5]
      )
      ...
      assert.sameOrderedMembers(
        getOpenValues(box1, sudokuGrid)[0] as number[],
        [1, 2, 5]
      )
      assert.sameOrderedMembers(
        getOpenValues(box1, sudokuGrid)[5] as number[],
        [1, 3, 5, 9]
      )
      assert.sameOrderedMembers(
        getOpenValues(box2, sudokuGrid)[0] as number[],
        [4, 5, 7, 9]
      )
      assert.sameOrderedMembers(
        getOpenValues(box2, sudokuGrid)[5] as number[],
        [4, 5, 9]
      )
    ...
    it('valid return of only unique possible answers - unsolved', function () {
      assert.sameOrderedMembers(getUniqueOpenValues(row1, sudokuGrid), [
        1,
        2,
        4,
        6,
      ...
      assert.sameOrderedMembers(getUniqueOpenValues(row2, sudokuGrid), [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(getUniqueOpenValues(column1, sudokuGrid), [
        1,
        2,
        3,
        9,
      ])
      assert.sameOrderedMembers(getUniqueOpenValues(column2, sudokuGrid), [
        3,
        4,
        5,
      ])

      assert.sameOrderedMembers(getUniqueOpenValues(box1, sudokuGrid), [
        1,
        2,
        3,
        5,
      ...
      assert.sameOrderedMembers(getUniqueOpenValues(box2, sudokuGrid), [
        2,
        4,
        5,
        7,
    ...
    it('valid return of only unique answers - solved', function () {
      assert.sameOrderedMembers(getUniqueSolvedValues(row1, sudokuGrid), [
        3,
        5,
        7,
      ])
      assert.sameOrderedMembers(getUniqueSolvedValues(row2, sudokuGrid), [
        7,
        8,
        9,
      ])

      assert.sameOrderedMembers(getUniqueSolvedValues(column1, sudokuGrid), [
        4,
        5,
        6,
        7,
      ...
      assert.sameOrderedMembers(getUniqueSolvedValues(column2, sudokuGrid), [
        1,
        2,
        6,
        7,
      ...
      assert.sameOrderedMembers(getUniqueSolvedValues(box1, sudokuGrid), [
        4,
        7,
        8,
      ])
      assert.sameOrderedMembers(getUniqueSolvedValues(box2, sudokuGrid), [
        1,
        3,
        6,
      ])
  ...
  describe('Cross-reference one grid parameter with another, removing overlapping values', function () {
    it('valid filtering of indexes', function () {
      assert.sameOrderedMembers(getExternal(getBox(0), getRow(0)), [
        3,
        4,
        5,
        6,
      ...
      assert.sameOrderedMembers(getExternal(getBox(40), getColumn(40)), [
        4,
        13,
        22,
        58,
      ...
      assert.sameOrderedMembers(getExternal(getBox(80), getRow(72)), [
        72,
        73,
        74,
        75,
    ...
    it('valid filtering of open indexes containing specified values', function () {
      const external1 = getOpenExternalWith(getBox(0), getRow(0), sudokuGrid, [
        2,
        8,
      ])
      assert.sameOrderedMembers(external1, [5, 8])
      const external2 = getOpenExternalWith(
        getBox(40),
        getColumn(40),
        sudokuGrid,
        [5]
      ...
      const external3 = getOpenExternalWith(
        getBox(80),
        getRow(72),
        sudokuGrid,
        [2, 6]
