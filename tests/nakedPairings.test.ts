...
import {
  ...
  solveNakedTriple,
  solveNakedQuad,
} from '../src/strategies/nakedPairings'
import {
  incorrectGrid2,
  singleNakedPairGrid,
  multiNakedPairGrid,
...
describe('Solve Naked Pairings', function () {
  describe('Solve Naked Pairs', function () {
    ...
    it('correct solution for multiple pairs', function () {
      const solutionList = solveNakedPair(
        multiNakedPairGrid,
        getRow(54)
      ) as Solution[]
      ...
      assert.sameOrderedMembers(SL1.cellInit as number[], [57, 58])
      ...
      assert.sameOrderedMembers(SL1.updates[0].currentAnswer, [
        1,
        4,
        5,
        6,
      ...
      assert.sameOrderedMembers(SL2.cellInit as number[], [59, 60])
      ...
      assert.sameOrderedMembers(SL2.updates[0].currentAnswer, [
        1,
        4,
        5,
        6,
      ...
      const bestSolution = filterBest(solutionList) as Solution
      assert.equal(bestSolution.updates[0].index, 54)
      assert.sameOrderedMembers(bestSolution.updates[0].removal, [1, 9])
      assert.sameOrderedMembers(bestSolution.updates[0].currentAnswer, [
        1,
        4,
        5,
        6,
      ...
      assert.sameOrderedMembers(bestSolution.updates[0].updatedAnswer, [
        4,
        5,
        6,
        7,
      ...
      assert.sameOrderedMembers(bestSolution.updates[1].currentAnswer, [
        1,
        4,
        5,
        6,
      ...
      assert.sameOrderedMembers(bestSolution.updates[1].updatedAnswer, [
        4,
        5,
        6,
      ])
  ...
  describe('Solve Naked Triples', function () {
    it('correct solution for single Triple', function () {
      ...
      assert.sameOrderedMembers(solution.updates[0].currentAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(solution.updates[0].updatedAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(solution.updates[1].currentAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(solution.updates[1].updatedAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(solution.updates[2].currentAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(solution.updates[2].updatedAnswer, [
        1,
        2,
        3,
        4,
    ...
    it('correct solution for multiple Triples', function () {
      const solutionList = solveNakedTriple(
        multiNakedTripleGrid,
        getRow(0)
      ) as Solution[]
      assert.equal(solutionList.length, 2)
      ...
      assert.sameOrderedMembers(SL1.cellInit as number[], [0, 1, 2])
      ...
      assert.sameOrderedMembers(SL1.updates[0].updatedAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(SL1.updates[1].currentAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(SL1.updates[1].updatedAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(SL1.updates[2].currentAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(SL1.updates[2].updatedAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(SL2.cellInit as number[], [6, 7, 8])
      ...
      assert.sameOrderedMembers(SL2.updates[0].updatedAnswer, [
        4,
        5,
        6,
        7,
      ...
      assert.sameOrderedMembers(SL2.updates[1].currentAnswer, [
        1,
        2,
        3,
        4,
      ...
      assert.sameOrderedMembers(SL2.updates[1].updatedAnswer, [
        4,
        5,
        6,
        7,
      ...
      assert.sameOrderedMembers(SL2.updates[2].currentAnswer, [
        1,
        2,
        3,
        4,
  ...
  describe('Solve Naked Quads', function () {
    ...
    it('correct solution for multiple Quads', function () {
      const solutionList = solveNakedQuad(
        multiNakedQuadGrid,
        getRow(54)
      ) as Solution[]
      const SL1 = solutionList[0]
      ...
      assert.sameOrderedMembers(SL1.cellInit as number[], [54, 55, 56, 57])
      ...
      assert.sameOrderedMembers(SL2.cellInit as number[], [59, 60, 61, 62])
      ...
      assert.sameOrderedMembers(bestSolution.cellInit as number[], [
        59,
        60,
        61,
        62,
  ...
  describe('Solve Naked Cascading Triples', function () {
    it('correct single solution', function () {
      ...
      assert.equal((SL1.updates as Update[]).length, 6)
      ...
      assert.sameOrderedMembers(SL1.updates[5].currentAnswer, [
        1,
        2,
        3,
        4,
    ...
    it('correct multiple solutions', function () {
      ...
      assert.sameOrderedMembers(SL1.cellInit as number[], [0, 1, 2])
      assert.sameOrderedMembers(SL1.removal, [1, 2, 3])
      assert.equal((SL1.updates as Update[]).length, 3)
      assert.equal(SL1.solved.length, 0)
      ...
      assert.equal((SL2.updates as Update[]).length, 3)
      ...
      assert.sameOrderedMembers(SL2.updates[2].updatedAnswer, [
        1,
        2,
        3,
        4,
  ...
  describe('Solve Naked Cascading Quads', function () {
    it('correct single solution', function () {
      ...
      assert.sameOrderedMembers(SL1.cellInit as number[], [0, 1, 2, 3])
      assert.sameOrderedMembers(SL1.removal, [1, 2, 3, 4])
      assert.equal((SL1.updates as Update[]).length, 5)
      assert.equal(SL1.solved.length, 0)
    ...
    it('correct multiple solutions', function () {
      ...
      assert.sameOrderedMembers(SL1.cellInit as number[], [0, 1, 2, 3])
      assert.sameOrderedMembers(SL1.removal, [1, 2, 3, 4])
      assert.equal((SL1.updates as Update[]).length, 1)
      assert.equal(SL1.solved.length, 0)
      ...
      assert.sameOrderedMembers(SL2.cellInit as number[], [5, 6, 7, 8])
      assert.sameOrderedMembers(SL2.removal, [6, 7, 8, 9])
      assert.equal((SL2.updates as Update[]).length, 1)
      assert.equal(SL2.solved.length, 0)
